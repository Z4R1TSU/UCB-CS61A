...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        cur_symbol, cur_expression = clause.first, scheme_eval(clause.rest.first, env)
        names, values = Pair(cur_symbol, names), Pair(cur_expression, values)
