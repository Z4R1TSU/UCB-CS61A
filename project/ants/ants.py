...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        cnt=0
        i=self.place
        while i is not beehive:
            if i.bees and self.min_range<=cnt<=self.max_range:
                return random.choice(i.bees)
            i=i.entrance
            cnt+=1
        return None
        # END Problem 3 and 4
...
# The WallAnt class
class WallAnt(Ant):
    """WallAnt does nothing each turn,they have a large armor value."""
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.has_queen_before:
            self.is_imposter=True
        else:
            QueenAnt.has_queen_before=True
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.is_imposter:
            ...
            i=self.place.exit
            while i:
                if i.ant and not i.ant.is_buffed:
                    i.ant.damage*=2
                    i.ant.is_buffed=True
                i=i.exit
        # END Problem EC
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        return  not (not self.place.ant or (self.place.ant and not self.place.ant.blocks_path))
...
class BodyguardAnt(ContainerAnt):
    ...
    def __init__(self, armor = 2, *args, **kwargs):
        ContainerAnt.__init__(self, armor, *args, **kwargs)
        self.armor = armor
...
def make_scare(action, bee):
    ...
    # BEGIN Problem Optional 4
    "*** YOUR CODE HERE ***"
    def scare_action(self, gamestate):
        bee.is_scared = True
        action(gamestate)
        bee.is_scared = False
    return lambda gamestate: scare_action(bee, gamestate)
    # END Problem Optional 4
